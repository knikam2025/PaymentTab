...
import { FaTimes, FaAirbnb } from "react-icons/fa"; // Importing icons for close button and Airbnb logo

// Payment component: Displays payment details in a sliding panel
const Payment = ({ isOpen, onClose }) => {
  const [activeTab, setActiveTab] = useState(0); // State to track which tab is active (0 for Payment Lines, 1 for Workflow Logs)
  ...
  return (
    <>
      ...
      >
        ...
        {/* User information section with Airbnb logo, email, and date */}
        ...
        {/* Tab navigation section for Payment Lines and Workflow Logs */}
        <div className="flex border-b bg-slate-200 mt-3 rounded-lg">
          <button
            className={`flex-1 py-2 bg-white m-1 rounded-xl text-center font-semibold ${
              activeTab === 0 ? "border-b-2" : "text-gray-500 bg-slate-200 mt-3 rounded-lg"
            }`}
          ...
          <button
            className={`flex-1 py-2 text-center bg-white m-1 rounded-xl font-semibold ${
              activeTab === 1 ? "border-b-2" : "text-gray-500 bg-slate-200 mt-3 rounded-lg"
            }`}
        ...
        {/* Content area that displays either Payment Lines or Workflow Logs based on active tab */}
